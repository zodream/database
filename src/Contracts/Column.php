...
interface Column {
    ...
    public function varchar(int $length = 10): Column;
    ...
    public function ai(int $begin = 1): bool;
    public function pk(bool $isAi = false): bool;
    public function unique(string $name = '', string $order = '');
    public function index(string $name = '', string $order = '');
    public function fk(Column $column, string $name = '');
}